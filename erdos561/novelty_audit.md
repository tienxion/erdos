...
4 September 2026. This is a literature audit, not a proof of priority. The full conjecture remains unresolved by our work. The audit includes discussion of an earlier exploratory two-star proof; the submitted local criterion and subsequent proof notes are linked from [the problem overview](README.md).
...
**“Ramsey-minimal graphs for multiple copies,”** *Indagationes Mathematicae (Proceedings)* 81, 187–195. [Original scan](https://www.renyi.hu/~p_erdos/1978-38.pdf); [DOI](https://doi.org/10.1016/S1385-7258(78)80009-2). Full paper read. The research workspace retains a local copy; the original scan is linked above.
...
**“Size Ramsey Results for the Path of Order Three,”** *Graphs and Combinatorics* 37, 2315–2331. [Publisher](https://link.springer.com/article/10.1007/s00373-021-02398-3); [PDF](https://link.springer.com/content/pdf/10.1007/s00373-021-02398-3.pdf). Full paper retrieved and read; the original PDF is linked above.
...
The June 3 v1 had claimed the full conjecture, but that result is absent from v2 and v3. Search engines and some secondary sites still quote v1. This audit uses the current v3 rather than treating that withdrawn claim as a theorem. Neither an obsolete abstract nor a secondary summary establishes that #561 is solved.
...
Subsequent work, kept outside that public PDF, gives a universal recursive refinement, matching-based recovery at additional gaps of two and one, and a complete mixed two-edge-star theorem. Full proofs and their audit status are in [recursive lower bound](improvement_recursive.md), [additional gap conditions](improvement_gap.md), and [mixed two-edge-star theorem](improvement_plateaus.md). These are additional results from this research session; that description is not a claim of established priority.
...
* The unavailable Cheng attachment was an HTML redirect. The research workspace retains that response; it must not be described as the retrieved thesis.
