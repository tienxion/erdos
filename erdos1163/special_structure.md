...
`extension_efficient_orbits.md`; it transfers to any larger class proved
...
`progress_v3.md`, `ell<=A+2(B0+B1)`, with Poisson means of orders
...
The independent audit in `audit_special_structure.md` found no gap.
The dominance theorem in `extension_eight_point_projections.md` transfers
