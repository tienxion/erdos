...
Let `J_n` be the class from [extension_efficient_orbits.md](extension_efficient_orbits.md): its
...
The representation bound from [extension_efficient_orbits.md](extension_efficient_orbits.md) gives,
...
The script [verify_bad_orbit_quotients.py](verify_bad_orbit_quotients.py) checks this without relying
...
[degree8_groups.json](degree8_groups.json) gives the same bound using the transitive-group
catalogue. Results are recorded in
[bad_orbit_quotient_verification.json](bad_orbit_quotient_verification.json).
