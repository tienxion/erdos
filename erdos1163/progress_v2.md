...
The following checks have been run in [verify_abelian.py](verify_abelian.py):
...
The separate [verify_odd_family.py](verify_odd_family.py) independently enumerates every
